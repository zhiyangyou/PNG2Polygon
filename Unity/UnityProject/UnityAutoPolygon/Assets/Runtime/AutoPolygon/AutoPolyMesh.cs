...
namespace AutoPolygon
{
    ...
    public class AutoPolyMesh : MonoBehaviour
    {
        ...
        [NonSerialized] public float CurOverDraw = 0.3f;
        [NonSerialized] public float MinOverDraw = 0.2f;
        ...
        private void OnDrawGizmos()
        {
            if (isDrawGizmos)
            {
                ...
                GizmosUtils.DrawInfos(_indices.Count / 3, CurOverDraw, MinOverDraw, transform);
            }
        }
